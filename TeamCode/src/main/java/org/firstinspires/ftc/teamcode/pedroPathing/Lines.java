...
@Config
@TeleOp
public class Lines extends OpMode {
    ...
    @Override
    public void start() {
        line1 = line(new Pose(72,72, 0), new Pose(DISTANCE + 72,72, 0)).linear(0,Math.toRadians(90));
        line2 = line(new Pose(DISTANCE + 72,72, 0), new Pose(72,72, 0)).linear(Math.toRadians(90),0);
